...
# --------------------------------------------------
def test_more_than_two_whitout_oxfordcomma():
    """more than two items but withoutnthe oxford comma"""
  ...
  # --------------------------------------------------
def test_more_than_two_different_separator():
    """more than two items with a separator chosen by the user"""
